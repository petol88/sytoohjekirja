...
## 2026-05-25 - Dictionary extraction from function bodies
**Learning:** Instantiating dictionaries inside function bodies incurs runtime overhead on every function call.
**Action:** Move static dictionaries to module-level scope.
