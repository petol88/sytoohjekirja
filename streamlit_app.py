...
def load_data():
    ...
    for k in protokollat_map:
        protokollat_map[k] = tuple([""] + sorted(protokollat_map[k]))

    return data, syopatyyppi_opts, protokollat_map
...
if view == "Laskuri":
    ...
    with col2:
        ...
        # 1. Luodaan syöpätyypin valikko käyttäen välimuistitettuja vaihtoehtoja
        valittu_syopatyyppi = st.selectbox("Syöpätyyppi", SYOPATYYPPI_OPTS)
        
        # 2. Haetaan valmiiksi lajitellut protokollat valitun syöpätyypin perusteella
