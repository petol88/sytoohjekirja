...
def load_data():
    ...
    # Pre-calculate derived UI state to avoid O(N) operations and allocations
    # on every Streamlit rerun.
    indikaatiot = set()
    protokolla_map = {"Kaikki": [], "Ei määritelty": []}
    ...
    # Convert lists to tuples to prevent further allocation overhead
...
if view == "Laskuri":
    ...
    with col2:
        ...
        # 1-3. Käytetään valmiiksi laskettuja arvoja (O(1) haku) O(N) laskennan sijaan
        ...
        # Tuplet lisätään tuplena: ("",) + protokollat välttääkseen list-allokaation
