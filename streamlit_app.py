...
def load_data():
    ...
    # Pre-calculate UI options to avoid O(N) operations on every rerun
    indikaatiot = set()
    ...
    # Sort the protocol lists in the map
...
if view == "Laskuri":
    ...
    with col2:
        ...
        # 1. Syöpätyypin valikko (vaihtoehdot esilaskettu ja välimuistissa)
        valittu_syopatyyppi = st.selectbox("Syöpätyyppi", syopatyyppi_opts)
        
        # 2. Haetaan esilasketusta mapista suodatetut protokollat O(1) ajassa
