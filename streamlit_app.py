...
if view == "Laskuri":
    ...
    with col2:
        ...
        # 2. Luodaan syöpätyypin valikko (käytetään valmiiksi laskettuja vaihtoehtoja)
        valittu_syopatyyppi = st.selectbox("Syöpätyyppi", SYOPATYYPPI_OPTS)
        
        # 3. Suodatetaan protokollat valitun syöpätyypin perusteella (käytetään valmiiksi laskettua mappia)
