...
# OPTIMIZATION: Hoisted inline lists to module-level tuple constants.
# In Streamlit, the entire script reruns on every interaction. Defining these
# inline causes redundant memory allocations. Tuples are faster to instantiate
# and prevent recreating the exact same iterable for rendering and .index() lookups.
