...
class TestLogic(unittest.TestCase):
    ...
    def test_maarita_hoitosuunnitelma_rintasyopa(self):
        ...
        res = maarita_hoitosuunnitelma_rintasyopa("Stage IIB", "T2", "N1", "M0", ReseptoriTila.NEGATIIVINEN, ReseptoriTila.NEGATIIVINEN, Ki67Tila.KORKEA, valittu_hoitolinja=Hoitolinja.ADJUVANTTI)
        self.assertIn("Hoitolinja: Adjuvantti", res)
