...
from oncology_helper.staging import laske_stage_rintasyopa, maarita_hoitosuunnitelma_rintasyopa, ReseptoriTila, Hoitolinja
...
class TestLogic(unittest.TestCase):
    ...
    def test_maarita_hoitosuunnitelma_rintasyopa(self):
        ...
        res = maarita_hoitosuunnitelma_rintasyopa("Stage IIB", "T2", "N1", "M0", ReseptoriTila.NEGATIIVINEN, ReseptoriTila.NEGATIIVINEN, "Korkea")
        ...
        res = maarita_hoitosuunnitelma_rintasyopa("Stage I", "T1c", "N0", "M0", ReseptoriTila.POSITIIVINEN, ReseptoriTila.POSITIIVINEN, "Korkea")
        ...
        res = maarita_hoitosuunnitelma_rintasyopa("Stage IIB", "T2", "N1", "M0",
                                                  ReseptoriTila.NEGATIIVINEN, ReseptoriTila.NEGATIIVINEN, "Korkea",
        ...
        res = maarita_hoitosuunnitelma_rintasyopa("Stage I", "T1b", "N0", "M0", ReseptoriTila.POSITIIVINEN, ReseptoriTila.NEGATIIVINEN, "Matala")
