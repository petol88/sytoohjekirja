...
from oncology_helper.ui.io_toxicity_view import IOToxicityView
...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        self.frames = {}
        for F in (MainMenu, LaskuriView, LevinneisyysView, PisteytyksetView, OhjeetView, ToxicityView, IOToxicityView):
