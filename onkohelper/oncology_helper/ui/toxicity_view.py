...
class ToxicityView(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.laake_cb = ttk.Combobox(sel_frame, textvariable=self.laake_var, state="readonly", values=_HAITTAVAIKUTUKSET_LAAKKEET, width=25)
    ...
    def on_laake_select(self, event=None):
        ...
        if laake:
            haitat = _HAITAT_PER_LAAKE[laake]
