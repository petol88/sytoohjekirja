...
HAITTAVAIKUTUKSET = {
    ...
    "Dabrafenibi + Trametinibi (Tafinlar + Mekinist)": {
        "Kuume (pyreksia)": {
            "Diagnostiikka ja huomioitavaa": "Kuume on yhdistelmähoidon yleisin ja tyypillisin haitta. DABRAFENIBI on kuumeen pääasiallinen aiheuttaja, joten ENSISIJAISESTI tauotetaan dabrafenibi ja trametinibia voidaan jatkaa muuttumattomalla annoksella. Sulje aina ensin pois infektio. Vakavassa muodossa voi liittyä vilunväristyksiä, hypotensiota, kuivumista ja munuaisten vajaatoimintaa.\n\nKuumeen uusiutuessa harkitse sekundaaripreventiota: antipyreetti (parasetamoli tai ibuprofeeni) aloitettuna kuumeen ensioireista ja jatkettuna väh. 24 h kuumeettomuuden jälkeen. Toistuvassa kuumeessa harkitse lisäksi kortikosteroidia (esim. prednisoloni 10 mg/vrk vähintään 5 vrk).",
            "Lämpö ≥ 38.5 °C (komplisoitumaton)": "TAUOTA DABRAFENIBI. JATKA TRAMETINIBIA muuttumattomalla annoksella. Antipyreetti (parasetamoli / ibuprofeeni) ja nesteytys. Aloita dabrafenibi uudelleen, kun potilas on ollut kuumeeton vähintään 24 h: ENSIMMÄISELLÄ kerralla samalla annoksella, kuumeen UUSIUTUESSA seuraavaksi pienemmällä annostasolla (annoslaskutaulukon mukaan).",
            "Toistuva kuume": "Tauota dabrafenibi uudelleen. Kun kuumeeton ≥ 24 h, jatka dabrafenibi SEURAAVAKSI PIENEMMÄLLÄ annostasolla. Harkitse kortikosteroidia (prednisoloni 10 mg/vrk ≥ 5 vrk) sekundaaripreventiona. Trametinibia jatketaan ennallaan.",
            "Vaikea / komplisoitunut kuume (lämpö > 40 °C, hypotensio, kuivuminen, munuaisten vajaatoiminta tai vilunväristykset)": "TAUOTA MOLEMMAT lääkkeet (dabrafenibi ja trametinibi). Sairaalahoidon tarpeen arvio, nesteytys iv tarvittaessa, antipyreetti ja kortikosteroidi. Kun toipunut ja kuumeeton ≥ 24 h, jatka dabrafenibi alennetulla annoksella ja trametinibi muuttumattomalla annoksella (tai harkinnan mukaan alennettuna). Jos toistuu vaikeana, lopeta dabrafenibi pysyvästi."
        },
